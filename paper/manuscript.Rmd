...
```{r baseline-ability-vs-age-hor, fig.env = "figure*", out.width="\\linewidth", fig.pos = "t", fig.align='center', fig.width=6.5, fig.height=3, set.cap.width=T, num.cols.cap=2, fig.cap = "Language ability vs. age by demographic group, from the baseline Rasch model."}
