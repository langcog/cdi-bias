...
We will re-examine these demographic regressions after trimming items showing extreme DIF, which is what we turn to now.
...
The full GLIMMERs, with all 680 CDI:WS items, are available on OSF, but were too large to include here.
