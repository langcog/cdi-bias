...
Biological factors are also predictive of language skill: first-born children tend to outpace their siblings, and female children tend to have better language skills than their age-matched male counterparts [@fenson1994].
...
Due to these good properties, CDIs have been adapted to dozens of languages, and a central repository of CDIs with datasets contributed from all over the world has been created [Wordbank; @frank2017; @frank2021].
Our focus will be on the vocabulary checklist portion of the CDI Words & Sentences (CDI:WS) form, comprised of 680 items across 22 categories (e.g., animals, vehicles, action words, pronouns) designed to assess the productive vocabulary of children 16 to 30 months of age.
...
Together, these desirable properties of CDI:WS vocabulary items have led researchers to 
