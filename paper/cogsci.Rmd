...
While it is possible that there is an underlying difference in language ability between demographic groups, could it also be possible that the tests are biased to some degree--and perhaps to a different degree in different languages?
