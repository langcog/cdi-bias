...
For each demographic factor, we pruned items with difficulty difference from >.25 SD to >3 SD.
Shown in Figure 5, the regression coefficient for sex was closest to 0 when almost all items were trimmed (>.25SD; 661/680 items trimmed)
