...
for(thresh in seq(.25, 2.5, .25)) {
  ...
  prune_defs <- intersect(intersect(subset(tmp_ses, extreme)$definition, 
...
# 2SD threshold
mm_sex2 <- get_extreme_item_difficulty_differences(mm_sex) # min: -.53 max: 1.06
mm_ses2 <- get_extreme_item_difficulty_differences(mm_ses) # min: -1.07 max: 1.13
mm_eth2 <- get_extreme_item_difficulty_differences(mm_eth) # min: -.64 max: 1.56

all_extreme <- rbind(subset(mm_sex2, extreme),
                     subset(mm_ses2, extreme),
                     subset(mm_eth2, extreme)) 
