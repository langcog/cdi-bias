...
```{r pruned-coefs, out.width="\\linewidth", fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.4, fig.height=4.75, set.cap.width=T, num.cols.cap=1, fig.cap = "Size of demographic effects (regression coefficients) vs. the threshold of pruned items."}
...
#   ggplot(aes(x=SDthreshold, y=beta, color=extreme)) + facet_wrap(. ~ Dimension, scales="free") + 
#   geom_point() + theme(legend.position = "bottom") + # geom_line() +
...
ggarrange(pr1, pr2, pr3, ncol=1, common.legend = T)
```
...
```{r demo-ability, include=T, out.width="\\linewidth", fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.5, fig.height=7.5, set.cap.width=T, num.cols.cap=1, fig.cap = "Scatterplots showing item difficulty per demographic group along each dimension."}
...
```{r, include=T, out.width="\\linewidth", fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.5, fig.height=3.5, set.cap.width=T, num.cols.cap=1, fig.cap = "CHILDES frequency of input to male vs. female children."}
