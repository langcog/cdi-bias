...
We analyze American English CDI: Words & Sentences administrations from `r nrow(d_demo)` children aged `r min(d_demo$age)` to `r max(d_demo$age)` from Wordbank [@Frank2016].
